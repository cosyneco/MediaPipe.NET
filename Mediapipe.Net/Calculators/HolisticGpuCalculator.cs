...
{
    public class HolisticGpuCalculator : IGpuCalculator<List<NormalizedLandmarkList>>
    {
        ...
        private const string graph_path = "mediapipe/graphs/holistic_tracking/holistic_tracking_gpu.pbtxt";
