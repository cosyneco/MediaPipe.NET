...
{
    public class HandGpuCalculator : IGpuCalculator<List<NormalizedLandmarkList>>
    {
        ...
        private const string graph_path = "mediapipe/graphs/hand_tracking/hand_tracking_desktop_live_gpu.pbtxt";
