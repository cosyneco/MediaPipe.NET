...
{
    public class BlazePoseCpuCalculator : Disposable, ICpuCalculator<NormalizedLandmarkList>
    {
        ...
        private const string graph_path = "mediapipe/graphs/pose_tracking/pose_tracking_cpu.pbtxt";
