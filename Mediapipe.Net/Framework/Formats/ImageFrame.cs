...
namespace Mediapipe.Framework.Formats
{
  public class ImageFrame : MpResourceHandle
  {
    ...
    public unsafe ImageFrame(ImageFormat.Types.Format format, int width, int height, int widthStep, ReadOnlySpan<byte> pixelData, Deleter deleter)
    ...
    ///   </list>
    /// </remarks>
    public ImageFrame(ImageFormat.Types.Format format, int width, int height, int widthStep, ReadOnlySpan<byte> pixelData)
